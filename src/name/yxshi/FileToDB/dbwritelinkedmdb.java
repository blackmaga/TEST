package name.yxshi.FileToDB;

import java.io.*;
import java.util.*;

import name.yxshi.database.dbReader;
import name.yxshi.database.dbWriter;
import name.yxshi.graph.WeightAssign;
...
public class dbwritelinkedmdb {
	...
	void dbdeal() throws IOException  {
		...
		fileName[0] = "E:\\Fdata\\linkedmdb\\linkedmdb.txt";
		writeGraph(fileName[0]);
		
		fileName[1] = "E:\\Fdata\\linkedmdb\\keyword.txt";
